export module Note {
	...
	public static initial: any;
	/** The last Play Note played. */
	public static lastRecorded: any;
	/** The second to last Play Note played. */
	public static secondToLastRecorded: any;
	/** The last Note played, regardless of whether in Play/Replay Mode **/
	public static lastAbsolute: any;
	/** The last Octave Note played. */
	public static lastOctave: any;
	/** The last Harmony Note played. */
	public static lastHarmony: any;
